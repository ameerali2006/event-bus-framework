...
interface DeleteConfirmModalProps {
  ...
  eventToDelete: EventDefinition | null;
}
...
export const DeleteConfirmModal: React.FC<DeleteConfirmModalProps> = ({
  ...
  if (!isOpen || !eventToDelete) return null;
      ...
      <div className="bg-slate-900 border border-white/10 rounded-2xl w-full max-w-md overflow-hidden shadow-2xl animate-[fadeIn_0.3s_ease-out_forwards]">
        ...
        <div className="p-6">
          <p className="text-slate-300 text-sm leading-relaxed mb-6">
            Are you sure you want to delete the event <strong className="text-indigo-400 font-mono">{eventToDelete.event_name}</strong>?
            This action is permanent and cannot be undone. Associated configurations will be detached.
          </p>
