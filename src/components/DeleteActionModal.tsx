...
interface DeleteActionModalProps {
  ...
  actionToDelete: ActionDefinition | null;
}
...
export const DeleteActionModal: React.FC<DeleteActionModalProps> = ({
  ...
  if (!isOpen || !actionToDelete) return null;
      ...
      <div className="bg-slate-900 border border-white/10 rounded-2xl w-full max-w-md overflow-hidden shadow-2xl animate-[fadeIn_0.3s_ease-out_forwards]">
        ...
        <div className="p-6">
          <p className="text-slate-300 text-sm leading-relaxed mb-6">
            Are you sure you want to delete the action <strong className="text-indigo-400 font-mono">{actionToDelete.action_type}</strong> ({actionToDelete.name || "—"})?
            This action is permanent and cannot be undone. Associated system rules will be detached.
          </p>
